                    ...
                    <table class="w-full" id="users-table">
                        <thead>
                            <tr style="background:linear-gradient(90deg,#fef2f2,#fff5f5);">
                                ...
                                <th class="px-6 py-4 text-left text-[11px] font-bold text-gray-500 uppercase tracking-wider">Role</th>
                                ...
                                <tr class="trow" style="animation-delay: {{ $index * 40 }}ms;">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <span class="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full text-xs font-bold
                                            ...
                                            <div class="w-1.5 h-1.5 rounded-full {{ $user->role === 'admin' ? 'bg-red-500' : 'bg-blue-500' }}"></div>
                                            {{ ucfirst($user->role) }}
                                        </span>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap">
                    ...
                    @foreach ($users as $index => $user)
                        <div class="p-5 trow" style="animation-delay: {{ $index * 40 }}ms;">
                            ...
                            <div class="flex items-center gap-2 pt-3 border-t border-gray-50">
                                ...
                                <button onclick="confirmDelete({{ $user->id }}, '{{ addslashes($user->name) }}')" class="flex-1 inline-flex items-center justify-center gap-1 px-3 py-1.5 text-[11px] font-semibold rounded-lg" style="color:#dc2626;background:#fee2e2;border:1px solid #fecaca;">
