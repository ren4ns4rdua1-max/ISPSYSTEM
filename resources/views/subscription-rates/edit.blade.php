...
ass="nav-tooltip">Analytics</span>
                            ...
                            <div class="input-wrapper input-wrapper-select">
                                ...
                                <select id="plan_type" name="plan_type"
                                    ...
                                    @foreach($planTypes as $type)
                                        <option value="{{ $type }}" {{ old('plan_type', $subscriptionRate->plan_type) == $type ? 'selected' : '' }}>{{ ucfirst($type) }}</option>
                                    @endforeach
                                </select>
                            </div>
                            @error('plan_type')
                            ...
                            <div class="input-wrapper input-wrapper-select">
                                ...
                                <select id="billing_cycle" name="billing_cycle"
                                    ...
                                    @foreach($billingCycles as $cycle)
                                        <option value="{{ $cycle }}" {{ old('billing_cycle', $subscriptionRate->billing_cycle) == $cycle ? 'selected' : '' }}>{{ ucfirst($cycle) }}</option>
                                    @endforeach
                                </select>
                            </div>
                            @error('billing_cycle')
