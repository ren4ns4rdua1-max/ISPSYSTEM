...
<head>
    ...
    <title>Add Technician - ISP Management</title>
...
<div id="main-content" class="flex flex-col flex-1 min-h-screen" style="margin-left:260px;">
    <header class="topbar sticky top-0 z-40 flex items-center justify-between px-7 py-3.5">
        <div class="flex items-center gap-3">
            ...
            <div>
                <h1 class="font-display font-bold text-gray-900 text-[20px]">Add Technician</h1>
                <p class="text-gray-400 text-[12px]">Add a new technician to your team</p>
            </div>
        </div>
        <div class="flex items-center gap-3">
    ...
    <main class="flex-1 p-6">
        <div class="max-w-2xl mx-auto">
            <form method="POST" action="{{ route('technicians.store') }}" class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
                @csrf
                <div class="space-y-4">
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-1">Name</label>
                        <input type="text" name="name" value="{{ old('name') }}" required class="w-full px-4 py-2 rounded-lg border border-gray-200 focus:outline-none focus:ring-2 focus:ring-red-300">
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-1">Email</label>
                        <input type="email" name="email" value="{{ old('email') }}" required class="w-full px-4 py-2 rounded-lg border border-gray-200 focus:outline-none focus:ring-2 focus:ring-red-300">
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-1">Phone Number</label>
                        <input type="text" name="phone_number" value="{{ old('phone_number') }}" required class="w-full px-4 py-2 rounded-lg border border-gray-200 focus:outline-none focus:ring-2 focus:ring-red-300">
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-1">Specialization</label>
                        <select name="specialization" class="w-full px-4 py-2 rounded-lg border border-gray-200 focus:outline-none focus:ring-2 focus:ring-red-300">
                    ...
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-1">Area Coverage</label>
                        <input type="text" name="area_coverage" value="{{ old('area_coverage') }}" placeholder="e.g., North Area, All Areas" class="w-full px-4 py-2 rounded-lg border border-gray-200 focus:outline-none focus:ring-2 focus:ring-red-300">
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-1">Status</label>
                        <select name="status" class="w-full px-4 py-2 rounded-lg border border-gray-200 focus:outline-none focus:ring-2 focus:ring-red-300">
                    ...
                    <div>
                        ...
                        <textarea name="notes" rows="3" class="w-full px-4 py-2 rounded-lg border border-gray-200 focus:outline-none focus:ring-2 focus:ring-red-300">{{ old('notes') }}</textarea>
                    </div>
                </div>
                <div class="flex gap-3 mt-6">
                    <a href="{{ route('technicians.index') }}" class="flex-1 px-4 py-2 text-center border border-gray-200 text-gray-700 rounded-lg hover:bg-gray-50">Cancel</a>
                    <button type="submit" class="flex-1 px-4 py-2 text-center text-white rounded-lg" style="background:linear-gradient(135deg,#dc2626,#b91c1c);">Save Technician</button>
                </div>
            </form>
        </div>
    </main>
