...
<aside id="sidebar" style="width:260px;" class="fixed left-0 top-0 h-full z-50 flex flex-col shadow-2xl">
    ...
    <nav class="flex-1 overflow-y-auto px-3 py-4 space-y-0.5">
        ...
        <!-- Technicians (Active) -->
        <div class="nav-wrapper relative">
            <a href="{{ route('technicians.index') }}" class="nav-item-inner flex items-center gap-3 px-3 py-2.5 rounded-xl transition-all"
               style="background:linear-gradient(135deg,rgba(220,38,38,.12),rgba(185,28,28,.08));border:1px solid rgba(220,38,38,.2);">
                ...
                <span class="collapsible text-sm font-semibold text-red-300" style="max-width:160px;">Technicians</span>
            </a>
...
<div id="main-content" class="flex flex-col flex-1 min-h-screen">
    ...
    <header class="topbar sticky top-0 z-40 flex items-center justify-between px-7 py-3.5">
        <div class="flex items-center gap-3">
            ...
            <div>
                <h1 class="font-display font-bold text-gray-900 text-[20px] leading-tight">Add Technician</h1>
            ...
            <div class="form-card bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
                ...
                <form method="POST" action="{{ route('technicians.store') }}" class="p-6 space-y-5">
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            <label class="block text-xs font-bold text-gray-600 uppercase tracking-wider mb-1.5">Email Address <span class="text-red-500">*</span></label>
                            <div class="input-wrapper">
                                <svg class="input-icon w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"/>
                                </svg>
                                <input type="email" name="email" value="{{ old('email') }}" required class="form-input" placeholder="e.g. john@example.com">
                            </div>
                        ...
                        <div>
                            ...
                            <div class="input-wrapper">
                                ...
                                <input type="text" name="phone_number" value="{{ old('phone_number') }}" required class="form-input" placeholder="e.g. 09123456789">
                            </div>
                        ...
                        <div>
                            ...
                            <div class="input-wrapper">
                                ...
                                <input type="text" name="area_coverage" value="{{ old('area_coverage') }}" class="form-input" placeholder="e.g., Barangay 1-5, City Center">
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div class="input-wrapper-select">
                                ...
                                <select name="status" class="form-input">
                                    ...
                                    <option value="offduty" {{ old('status') == 'offduty' ? 'selected' : '' }}>Off Duty</option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div class="input-wrapper">
                                ...
                                <textarea name="notes" rows="3" class="form-input" placeholder="Additional notes about this technician...">{{ old('notes') }}</textarea>
                            </div>
                        </div>
                    </div>
