...
<div id="main-content" class="flex flex-col flex-1 min-h-screen" style="margin-left:260px;">
    <header class="topbar sticky top-0 z-40 flex items-center justify-between px-7 py-3.5">
        <div class="flex items-center gap-3">
            <a href="{{ route('technicians.show', $technician->id) }}" class="w-8 h-8 bg-gray-100 hover:bg-gray-200 rounded-lg flex items-center justify-center transition-colors">
                <svg class="w-4 h-4 text-gray-600" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 19l-7-7 7-7"/></svg>
            </a>
            <div>
                <h1 class="font-display font-bold text-gray-900 text-[20px]">Edit Technician</h1>
                <p class="text-gray-400 text-[12px]">Update technician information</p>
            </div>
        </div>
        <div class="flex items-center gap-3">
    ...
    <main class="flex-1 p-6">
        <div class="max-w-2xl mx-auto">
            <form method="POST" action="{{ route('technicians.update', $technician->id) }}" class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
                @csrf
                @method('PUT')
                <div class="space-y-4">
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-1">Name</label>
                        <input type="text" name="name" value="{{ old('name', $technician->name) }}" required class="w-full px-4 py-2 rounded-lg border border-gray-200 focus:outline-none focus:ring-2 focus:ring-red-300">
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-1">Email</label>
                        <input type="email" name="email" value="{{ old('email', $technician->email) }}" required class="w-full px-4 py-2 rounded-lg border border-gray-200 focus:outline-none focus:ring-2 focus:ring-red-300">
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-1">Phone Number</label>
                        <input type="text" name="phone_number" value="{{ old('phone_number', $technician->phone_number) }}" required class="w-full px-4 py-2 rounded-lg border border-gray-200 focus:outline-none focus:ring-2 focus:ring-red-300">
                    </div>
                    <div>
                    ...
                    <div>
                        ...
                        <input type="text" name="area_coverage" value="{{ old('area_coverage', $technician->area_coverage) }}" class="w-full px-4 py-2 rounded-lg border border-gray-200 focus:outline-none focus:ring-2 focus:ring-red-300">
                    </div>
                    <div>
                    ...
                    <div>
                        ...
                        <textarea name="notes" rows="3" class="w-full px-4 py-2 rounded-lg border border-gray-200 focus:outline-none focus:ring-2 focus:ring-red-300">{{ old('notes', $technician->notes) }}</textarea>
                    </div>
                </div>
                <div class="flex gap-3 mt-6">
                    <a href="{{ route('technicians.show', $technician->id) }}" class="flex-1 px-4 py-2 text-center border border-gray-200 text-gray-700 rounded-lg hover:bg-gray-50">Cancel</a>
                    <button type="submit" class="flex-1 px-4 py-2 text-center text-white rounded-lg" style="background:linear-gradient(135deg,#dc2626,#b91c1c);">Update Technician</button>
                </div>
            </form>
        </div>
    </main>
