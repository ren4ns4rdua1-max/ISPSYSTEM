...
<div id="main-content" class="flex flex-col flex-1 min-h-screen" style="margin-left:260px;">
    ...
    <main class="flex-1 p-6">
        <form action="{{ route('payments.store') }}" method="POST" class="max-w-3xl">
            @csrf
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 mb-6">
                ...
                <div id="client-details" class="mt-5 p-4 bg-gray-50 rounded-xl hidden">
                    <div class="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
                        <div>
                            <p class="text-gray-500">PPPoE Name</p>
                            <p class="font-medium text-gray-800" id="client-pppoe">-</p>
                        </div>
                        <div>
                            <p class="text-gray-500">Phone</p>
                            <p class="font-medium text-gray-800" id="client-phone">-</p>
                        </div>
                        <div>
                            <p class="text-gray-500">Barangay</p>
                            <p class="font-medium text-gray-800" id="client-barangay">-</p>
                        </div>
                        <div>
                            <p class="text-gray-500">Current Plan</p>
                            <p class="font-medium text-gray-800" id="client-plan">-</p>
                        </div>
                    </div>
                </div>
                ...
                <div id="outstanding-bills" class="mt-4 hidden">
                    <h3 class="text-sm font-semibold text-gray-700 mb-3">Outstanding Bills</h3>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="number" name="amount" id="amount" step="0.01" min="0" value="{{ old('amount') }}" required class="w-full pl-8 pr-4 py-2.5 rounded-xl border border-gray-200 text-sm focus:outline-none focus:ring-2 focus:ring-red-300">
                        </div>
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <span class="absolute left-4 top-1/2 -translate-y-1/2 text-gray-500">₱</span>
                            <input type="number" name="total_paid" id="total_paid" step="0.01" min="0" value="{{ old('total_paid') }}" required class="w-full pl-8 pr-4 py-2.5 rounded-xl border border-gray-200 text-sm focus:outline-none focus:ring-2 focus:ring-red-300">
                        </div>
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <span class="absolute left-4 top-1/2 -translate-y-1/2 text-gray-500">₱</span>
                            <input type="number" name="change_amount" id="change_amount" step="0.01" min="0" value="{{ old('change_amount', 0) }}" class="w-full pl-8 pr-4 py-2.5 rounded-xl border border-gray-200 text-sm focus:outline-none focus:ring-2 focus:ring-red-300">
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <input type="date" name="payment_date" value="{{ old('payment_date', date('Y-m-d')) }}" required class="w-full px-4 py-2.5 rounded-xl border border-gray-200 text-sm focus:outline-none focus:ring-2 focus:ring-red-300">
                    ...
                    <div>
                        ...
                        <input type="text" name="payment_reference" value="{{ old('payment_reference') }}" placeholder="Reference number (optional)" class="w-full px-4 py-2.5 rounded-xl border border-gray-200 text-sm focus:outline-none focus:ring-2 focus:ring-red-300">
                    </div>
                </div>
                
                <div class="mt-5">
                    <label class="block text-sm font-medium text-gray-700 mb-2">Notes</label>
                    <textarea name="notes" rows="3" placeholder="Additional notes (optional)" class="w-full px-4 py-2.5 rounded-xl border border-gray-200 text-sm focus:outline-none focus:ring-2 focus:ring-red-300">{{ old('notes') }}</textarea>
                </div>
            </div>
