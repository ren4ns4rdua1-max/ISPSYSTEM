            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    ...
                    <div class="bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <input type="date" name="billing_date" value="{{ old('billing_date', $billing->billing_date->format('Y-m-d')) }}" required class="w-full text-sm bg-gray-50 rounded-lg px-4 py-2.5 border-0 focus:outline-none focus:ring-2 focus:ring-red-300">
                            ...
                            <div>
                                ...
                                <input type="date" name="due_date" value="{{ old('due_date', $billing->due_date->format('Y-m-d')) }}" required class="w-full text-sm bg-gray-50 rounded-lg px-4 py-2.5 border-0 focus:outline-none focus:ring-2 focus:ring-red-300">
                ...
                <div class="space-y-6">
                        ...
                        <div class="space-y-4">
                            <div>
                                ...
                                <div class="relative">
                                    ...
                                    <input type="number" name="amount" id="amount" value="{{ old('amount', $billing->amount) }}" step="0.01" min="0" required class="w-full text-sm bg-gray-50 rounded-lg pl-8 pr-4 py-2.5 border-0 focus:outline-none focus:ring-2 focus:ring-red-300">
                                </div>
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    <span class="absolute left-3 top-1/2 -translate-y-1/2 text-gray-500">₱</span>
                                    <input type="number" name="tax_amount" id="tax_amount" value="{{ old('tax_amount', $billing->tax_amount) }}" step="0.01" min="0" class="w-full text-sm bg-gray-50 rounded-lg pl-8 pr-4 py-2.5 border-0 focus:outline-none focus:ring-2 focus:ring-red-300">
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    <span class="absolute left-3 top-1/2 -translate-y-1/2 text-gray-500">₱</span>
                                    <input type="number" name="discount_amount" id="discount_amount" value="{{ old('discount_amount', $billing->discount_amount) }}" step="0.01" min="0" class="w-full text-sm bg-gray-50 rounded-lg pl-8 pr-4 py-2.5 border-0 focus:outline-none focus:ring-2 focus:ring-red-300">
                                </div>
                            </div>
                            ...
                            <div class="pt-4 border-t border-gray-100">
                                <div class="flex justify-between items-center">
                                    ...
                                    <span id="total-display" class="text-xl font-bold text-gray-900">₱{{ number_format($billing->total_amount, 2) }}</span>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
                        ...
                        <div class="space-y-4">
                            <div>
                                ...
                                <input type="date" name="paid_date" value="{{ old('paid_date', $billing->paid_date?->format('Y-m-d')) }}" class="w-full text-sm bg-gray-50 rounded-lg px-4 py-2.5 border-0 focus:outline-none focus:ring-2 focus:ring-red-300">
                            </div>
                            ...
                            <div>
                                ...
                                <input type="text" name="payment_reference" value="{{ old('payment_reference', $billing->payment_reference) }}" class="w-full text-sm bg-gray-50 rounded-lg px-4 py-2.5 border-0 focus:outline-none focus:ring-2 focus:ring-red-300">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
                        ...
                        <textarea name="notes" rows="3" class="w-full text-sm bg-gray-50 rounded-lg px-4 py-2.5 border-0 focus:outline-none focus:ring-2 focus:ring-red-300">{{ old('notes', $billing->notes) }}</textarea>
                    </div>
                    ...
                    <div class="flex gap-3">
                        ...
                        <button type="submit" class="flex-1 px-6 py-3 text-center text-sm font-semibold text-white rounded-xl shadow-md hover:shadow-lg transition-all" style="background:linear-gradient(135deg,#dc2626,#b91c1c);">Update Invoice</button>
                    </div>
                </div>
            </div>
        </form>
