...
<script>
    ...
    const clientsData = @json($clients->mapWithKeys(function($client) {
        return [$client->id => [
            'name' => $client->name,
            'email' => $client->email,
    ...
    function calculateTotal() {
        ...
        document.getElementById('total-display').textContent = '₱' + total.toLocaleString('en-PH', {minimumFractionDigits: 2, maximumFractionDigits: 2});
    }
    ...
    document.getElementById('client_id').addEventListener('change', function() {
        ...
        if (clientId && clientsData[clientId]) {
            ...
            document.getElementById('detail-barangay').textContent = client.barangay || '-';
